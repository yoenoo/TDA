...
def _load_mnist(root="./data", train=True, normalize=True, flatten=False, subset_labels=None, **kwargs):
...
def load_mnist(batch_size: int, flatten=False, subset_labels=None):
  train_loader = _load_mnist(train=True, shuffle=True, flatten=flatten, 
                             batch_size=batch_size, subset_labels=subset_labels)
  test_loader  = _load_mnist(train=False, shuffle=False, flatten=flatten, 
                             batch_size=batch_size, subset_labels=subset_labels)
